...
class Noise {
    gain; node;
    constructor(frequency : number, public duration : number, public gainEnvelope : any[]) {
...
class Sound {
    osc; gain;
    constructor(type : string, public duration : number, public frequencyEnvelope : any [], public gainEnvelope: any[], public baseFreq : number = 440, public bend = true) {
        this.osc
...
var registeredSounds = {
    'ballBomp' : new Sound('triangle', 0.7,
    [[0,0],[12,0.2],[0,0.4],[12,0.6],[0,0.8],[12,1.0]],
    [[1.0,0.0]], 240 ),
    'laserHit' : new Sound('sawtooth', 0.2,
    [[0,0]],
    [[0.1,0],[0.1,0.7],[1.0,0.8]], 540 ),
    'bulletHit' : new Sound('square', 0.2,
    [[0,0]],
    [[1.0,0]], 540 ),
    'monsterHit' : new Sound('square', 0.5,
    [[0,0],[24,0.3],[0,0.8]],
    [[1.0,0.0]], 30),
    'artyDrop' : new Sound('sine', 1,
    [[12,0],[24,0.2],[12,0.35],[24,0.5]],
    [[0.5,0.0],[1.0,0.5],[1.0,0.6]], 440, false),
    'item1' : new Sound('sine', 0.2,
    [[12,0],[12,0.49],[24,0.5],[24,1.0]],
    [[1.0,0],[0.01,0.49],[1.0,0.5]], 440),
    'item2' : new Sound('sine', 0.2,
    [[19,0],[19,0.49],[31,0.5],[31,1.0]],
    [[1.0,0],[0.01,0.49],[1.0,0.5]], 440),
    'warp1' : new Sound('square', 2.0,
    [[0,0],[7,0.25],[12,0.5]],
    [[1.0,0.0],[0.01,0.24],[1.0,0.25],[0.01,0.49],[1.0,0.5],[1.0,0.55]], 40),
    'warp2' : new Sound('sawtooth', 1.5,
    [[24,0],[31,0.33],[36,0.66]],
    [[1.0,0.0],[0.01,0.32],[1.0,0.33],[0.01,0.65],[1.0,0.66]], 40),
    'bossHit1' : new Sound('square', 1.0,
    [[12,0]],
    [[1.0,0.0],[0.3,0.5]], 50),
    'bossHit2' : new Sound('sawtooth', 1.0,
    [[48,0],[0,1.0]],
    [[1.0,0.0],[0.3,0.5]], 50),
...
function playSound(snd) {
    return () => registeredSounds[snd].play();
}
